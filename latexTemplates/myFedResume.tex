...
%-------------------------------------------------------------------------------
\begin{center}
    \textbf{\Huge \scshape Steven F. Wolf, Ph.D.} \\ \vspace{1pt}
    1637 Upland Dr., Greenville, NC 27858 \\ \vspace{1pt}
    586-484-3661 \ $|$ \ stevenwolf1687@gmail.com \\ \vspace{1pt} % Recommended not to include email link or other hyperlinks in resume PDF submitted to USAJobs
\end{center}

ANNOUNCEMENT NUMBER: 25-NT-01101-12635066-DH \\ \vspace{1pt} % Copy and paste the announcement number from the job you are applying to
Veteran's Preference: None $|$ \ Federal Employment Status: None $|$ \ Citizenship: USA % List your veteran's preference, fed employment status, and current citizenship. Put N/A if one of these does not apply to you

%-------------------------------------------------------------------------------
%	RESUME CONTENT
%   These are the sections from the USAJobs resume builder
%	Each section is imported separately
%   Open each file in 'resumeSections' to modify content
...
\input{resumeSections/volExp}

%-----------EDUCATION----------- 
\input{resumeSections/education}

%-----------JOB RELATED TRAINING-----------
%\input{resumeSections/training}

%-----------AFFILIATIONS-----------
\input{resumeSections/affil}

%-----------PROFESSIONAL PUBLICATIONS-----------
\input{resumeSections/pubs}

%-----------REFERENCES-----------
\input{resumeSections/refs}

%-----------ADDITIONAL INFORMATION-----------
%\input{resumeSections/addlInfo}
