---
description: Profile onboarding - set up your professional profile
---
...
>
> I'll help you build your professional profile so opencode can evaluate job postings, tailor CVs, write cover letters, and prepare you for interviews.
>
...
Then proceed to Step 3 to populate the non-skill files (`OPENCODE.md`, `cv/main_example.tex`, `.opencode/skills/job-scraper/search-queries.md`). Step 3 will detect that the seven skill files are already populated and skip those substeps.
...
>
> - `OPENCODE.md` - Your full candidate profile
