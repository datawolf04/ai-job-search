---
description: Run the full application workflow (evaluate, draft, review)
---
...
Run the full verification checklist from `OPENCODE.md` now — this is the **only** verification pass in the workflow. Re-read both files once here to verify final state on disk matches your mental model after the Step 4 and Step 5 edits.

### Verification Checklist
Report pass/fail for each item in the OPENCODE.md verification checklist (factual accuracy, targeting, consistency, quality).
